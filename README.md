...
| MAE | RUL regression | mean(|actual − pred|) |
...
1. **PRONOSTIA Dataset** — IEEE PHM 2012 Data Challenge, FEMTO-ST Institute.  
...
2. **Original paper methodology** — Multi-branch deep learning with AB-LSTM for RUL estimation using 1D features, CWT spectrograms, and raw denoised signals with joint OC + RUL loss.

3. **CRISP-DM** — Chapman P. et al., "CRISP-DM 1.0: Step-by-step data mining guide." *SPSS Inc.*, 2000.

4. **PyWavelets** — Lee G. et al., "PyWavelets: A Python package for wavelet analysis." *Journal of Open Source Software*, 2019.

5. **SHAP** — Lundberg S. & Lee S., "A unified approach to interpreting model predictions." *NeurIPS*, 2017.
